...
let llistaDeParaulesExpertes = ["abaixallengües", "abalançar-se", "abans-d'ahir", "abatiment", "aberració", 
    "abeurador", "abominable", "abonament", "abonyegar", "abreviació", "absolutisme", "abstenir-se", "abstracte", 
    "acabarien", "acampanada", "acaramel·lar", "aclofar-se", "acolliment", "acovardir-se", "acrobàcia", "adeu-siau", 
    "adquisició", "afanyar-se", "albercoquer", "alcoholímetre", "al·leluia", "al·lèrgia", "al·lucinació", "antecessor", 
    "antepenúltim", "antiguitat", "antipàtic", "antiquari", "aquarel·la", "aqüeducte", "arquitecte", "arreplegar", 
    "arrossegar", "arxipèlag", "assessorar", "atonyinar", "autoestop", "avaluació", "m'avorreixo", "baliga-balaga", 
    "bandolerisme", "barrabassada", "bilingüisme", "bocabadat", "bocaterrosa", "bombardejar", "borrissol", "botifarra", 
    "bronzejador", "calamarsa", "calçotada", "cal·ligrafia", "cancel·lar", "cansalada", "capbussada", "capdavall", 
    "capil·lar", "carabassa", "carabassó", "caragirat", "caramel·litzat", "cascavell", "causalitat", "centígrad", 
    "cinquanta", "circumstància", "clandestí", "clatellot", "coaccionar", "coherència", "col·laboració", "col·lapse", 
    "col·lateral", "col·leccionisme", "col·lisió", "col·locar", "col·loquial", "col·lutori", "comissaria", "commemorar", 
    "compassió", "compromís", "comunament", "concloent", "concordança", "confessió", "confiança", "confitura", "conreador", 
    "conseqüent", "constel·lació", "constipat", "construïen", "contagiós", "contínuament", "contraatacar", "contraban", 
    "contraent", "contrallum", "contrasenya", "convèncer", "cooperatiu", "coordinar", "coreografia", "cornamusa", 
    "corpulent", "correcuita", "cotorrejar", "credibilitat", "cremallera", "cristal·lí", "cronòmetre", "cucurutxo", 
    "cul-de-sac", "cullerada", "curandero", "currículum", "curtcircuitar", "curtmetratge", "daixonses", "daltabaix", 
    "deambular", "decapitar", "deliberat", "democràcia", "dentadura", "deplorable", "depredador", "derrapada", "derrotista", 
    "desapercebut", "descalcificador", "desdir-se'n", "desenvolupament", "desempallegar-se", "deshumanitzar", "desodorant", 
    "destarotador", "destil·lada", "desxifrar", "deteriorar", "diglòssia", "disciplina", "dissimulaven", "dissolien", 
    "distribuïdor", "druïdessa", "eixamplar-se", "embarbussament", "emmagatzemar", "empastifar", "enllefiscar", "ensaïmada", 
    "entra-i-surt", "escarxofa", "esgarrapada", "esparracar", "estel·lar", "estereotip", "estribord", "eucariota", 
    "eufemisme", "excel·lència", "exposició", "fal·làcia", "falsificar", "faràndula", "flirtejar", "fluorescència", 
    "folklòric", "fonamental", "formatget", "forquilla", "freqüència", "galimaties", "guarderia", "hipopòtam", "holocaust", 
    "horripilar", "hortalissa", "hortènsia", "idoneïtat", "il·legible", "il·limitat", "il·luminat", "immaculat", 
    "immutar-se", "impecable", "impermeable", "impressora", "infal·lible", "intel·lecte", "kilòmetre", "lingüístic", 
    "llengüeta", "magdalena", "mal·leabilitat", "mandarina", "mandíbula", "matrícula", "menysprear", "meravellós", 
    "metàl·lic", "metal·lòfon", "metamorfosi", "milionèsim", "mil·lenni", "mortadel·la", "necessitat", "nyigui-nyogui", 
    "palíndrom", "pampallugues", "pandereta", "pantomima", "panxacontent", "paraigüer", "paral·lel", "parenostre", 
    "parentela", "parèntesi", "parquímetre", "parsimònia", "parvulari", "passarel·la", "pastanaga", "pelleringa", 
    "pel·lícula", "pengim-penjam", "percussió", "perepunyetes", "pessigolles", "ping-pong", "pingponguista", "plantofada", 
    "plànyer-se", "ploramiques", "plovisqueig", "pneumàtic", "pneumònia", "pocatraça", "pol·lució", "polseguera", 
    "porcellana", "portaavions", "posseïdor", "preeminent", "prehistòria", "pronòstic", "pronúncia", "pseudònim", 
    "pul·lular", "putxinel·li", "qualsevol", "quíntuple", "radiooient", "ratapinyada", "rebel·lió", "relativitzar", 
    "relliscada", "renaixença", "repel·lent", "república", "ressuscitar", "revolució", "sabotatge", "sarbatana", 
    "satèl·lit", "sol·licitar", "taral·larejar", "tovallola", "tranquil·litat", "transeünt", "vacil·lar"]
