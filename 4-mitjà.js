...
let llistaDeParaulesMitjanes = ["abandó", "abatre", "abisme", "abocar", "abolir", "absent", "acatar", "acudit", "advent", 
    "afanar", "agonia", "agrair", "agraït", "aguait", "àguila", "ambdós", "anxova", "anyell", "arcaic", "arquer", "ascens", 
    "asfalt", "avaria", "baieta", "bàrbar", "barnús", "bateig", "beneït", "beneit", "bobina", "bohemi", "bonsai", "cactus", 
    "càmera", "caneló", "celíac", "cérvol", "civada", "cocció", "codony", "compte", "conyac", "córrer", "covard", "cràter", 
    "crostó", "cunyat", "davant", "diàleg", "dibuix", "dièsel", "diluvi", "disset", "diürna", "dòmino", "èczema", "efímer", 
    "embrió", "èmfasi", "emprar", "endemà", "endoll", "enigma", "enlloc", "enrere", "enveja", "envers", "epítet", "erosió", 
    "escena", "esclop", "esfinx", "esglaó", "esmena", "espiar", "estanc", "estany", "estela", "estoig", "estruç", "eureka", 
    "evadir", "examen", "façana", "faceta", "faquir", "farina", "fàrmac", "farola", "fàstic", "festuc", "ficció", "filmar", 
    "fingir", "flaire", "fletxa", "flexió", "folrar", "fòssil", "fràgil", "follet", "fressa", "fúcsia", "gargot", "gasela", 
    "gènere", "geniüt", "globus", "hèlice", "híbrid", "hípica", "hivern", "honest", "hòstia", "ianqui", "Ignasi", "iguana", 
    "il·lès", "il·lús", "imatge", "immens", "immune", "ímpetu", "imprès", "impune", "inflar", "joquer", "làctic", "làpida", 
    "lavabo", "líquid", "llança", "llardó", "lluïda", "maleït", "marisc", "màrtir", "menhir", "mestís", "mètode", "mètric", 
    "minvar", "míssil", "mosaic", "mossèn", "mullar", "muntar", "múscul", "mussol", "nadala", "nèctar", "néixer", "nivell", 
    "nòrdic", "número", "obscur", "òrbita", "orxata", "pàgina", "païble", "països", "palpís", "pàmfil", "papada", "pardal", 
    "parrac", "parxís", "pasqua", "pastís", "pàtria", "pelicà", "peluix", "pèndol", "pèrdua", "pèssim", "peülla", "pícnic", 
    "pijama", "pingüí", "pispar", "pitjor", "pixera", "plàcid", "plànol", "platja", "pomada", "pòster", "precís", "prémer", 
    "procés", "pròfug", "pròleg", "pròpia", "pròxim", "públic", "queixa", "químic", "quinzè", "rabiüt", "ràfega", "rajolí", 
    "ral·li", "rancor", "rasant", "ratolí", "rebuig", "recent", "reclús", "record", "rècord", "reflex", "reforç", "rèptil", 
    "rínxol", "romanç", "ròtula", "ruixat", "rústic", "sabana", "sabata", "safata", "saliva", "sencer", "sèptim", "símbol", 
    "sòbria", "sobtat", "sorgir", "súbdit", "subtil", "succés", "tàctil", "tècnic", "tennis", "tèxtil", "til·la", "tothom", 
    "través", "trèvol", "vànova", "vedell", "veïnat", "vèncer", "vèrtex", "vespre", "vessar", "xerrar", "xiulet"]
